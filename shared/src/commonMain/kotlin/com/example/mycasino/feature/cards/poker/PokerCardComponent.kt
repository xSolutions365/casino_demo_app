...
class PokerCardComponent : CardComponent {
    override val id: String
        get() = "poker_card_feature"

    @Composable
    override fun Content() {
        val viewModel: PokerCardViewModel = koinViewModel()
                ...
                when (val result = state) {
                    ...
                    is CardUiState.Success -> {
                        Column {
                            ...
                            Text(result.data.description, style = MaterialTheme.typography.bodyMedium
                            )
                        }
                    }
                }
